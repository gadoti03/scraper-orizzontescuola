...
const ScienzeDellaNutrizioneUmanaS = () => {
  React.useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
    ...
    const divContent = (  <div className='ProgrammaCdL'>
        ...
        <p>
        Al termine del percorso di studi lo studente consegue il titolo di Laurea Magistrale in Scienze della Nutrizione Umana. Il titolo conseguito appartiene al secondo ciclo della formazione universitaria, ha valore legale e consente la qualificazione di dottore magistrale.
        </p>
        </div>)
    ...
    const titolo=`SCIENZE DELLA NUTRIZIONE UMANA`;
    const array2=[
        'Laurea Magistrale',
        'Laurea',
    ...
    const array3=['SCIENZE DELLA NUTRIZIONE UMANA'];
    const pdf = '/ScienzeDellaNutrizioneUmanaS.pdf'; //messo in public
...
export default ScienzeDellaNutrizioneUmanaS;