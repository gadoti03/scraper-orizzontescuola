...
const IngegneriaIndustrialeS = () => {
  React.useEffect(() => {
    ...
    const divContent = (  <div className='ProgrammaCdL'>
        ...
        <p>
        Al termine del percorso di studi lo studente consegue il titolo di Laurea Magistrale in Ingegneria Industriale. Il titolo conseguito appartiene al secondo ciclo della formazione universitaria, ha valore legale, consente la qualificazione di dottore magistrale e la possibilità di effettuare l’esame di stato per l’accesso all’albo A degli ingegneri.        </p>
        </div>)

    const array1=['2 anni', '2021', 'Aperto', '120CFU', 'Italiano', 'Corsi di Laurea Magistrale', 'D.M. 270/2004', 'LM-33 - Classe delle lauree magistrali in Ingegneria meccanica', 'No', 'Libero', 'INGEGNERIA', 'CORSO DI LAUREA ORDINARIO' ];
    const titolo=`INGEGNERIA INDUSTRIALE`;
    const array2=[
        'Laurea Magistrale',
        'Laurea',
    ...
    const array3=[`INDUSTRIA 4.0`, 'PROGETTUALE MECCANICO', 'TECNOLOGICO GESTIONALE','TERMOMECCANICO'];
    const pdf = '/IngegneriaIndustrialeS.pdf'; //messo in public
...
export default IngegneriaIndustrialeS;