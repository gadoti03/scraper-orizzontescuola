...
const LingueECultureEuropeeEDelRestoDelMondo = () => {
  React.useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
...
const divContent = (  <div className='ProgrammaCdL'>
  ...
  <p>
  Al termine del percorso di studi lo studente consegue il titolo di Laurea in Lingue e Culture Europee e del Resto del Mondo. Il titolo conseguito appartiene al primo ciclo della formazione universitaria, ha valore legale e consente la qualificazione di dottore.  </p>
</div>)

    const array1=['3 anni', '2017', 'Aperto', '180CFU', 'Italiano', 'Corsi di Laurea', 'D.M. 270/2004', '    L-11 - Classe delle lauree in Lingue e culture moderne', 'No', 'Libero', 'LETTERE', 'CORSO DI LAUREA ORDINARIO' ];
    const titolo='DESIGN E DISCIPLINE DELLA MODA (D.M. 270/04)';
    const array2=['Titolo di Scuola Superiore', 'Titolo straniero'];
    const array3=['LINGUE E CULTURE EUROPEE E DEL RESTO DEL MONDO'];
    const pdf = '/LingueECultureEuropeeEDelRestoDelMondo.pdf'; //messo in public
...
export default LingueECultureEuropeeEDelRestoDelMondo;