...
const IngegneriaCivileEAmbientale = () => {
  React.useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
    ...
    const array1=['3 anni', '2017', 'Aperto', '180CFU', 'Italiano', 'Corsi di Laurea', 'D.M. 270/2004', 'L-7 - Classe delle lauree in Ingegneria civile e ambientale', 'No', 'Libero', 'INGEGNERIA', 'CORSO DI LAUREA ORDINARIO' ];
    const titolo='INGEGNERIA CIVILE E AMBIENTALE (D.M. 270/04)';
    const array2=['Titolo di Scuola Superiore', 'Titolo straniero'];
    const array3=['CIVILE E AMBIENTALE', 'PAESAGGISTICO', 'comune'];
    const pdf = '/IngegneriaCivileEAmbientale.pdf'; //messo in public
...
export default IngegneriaCivileEAmbientale;