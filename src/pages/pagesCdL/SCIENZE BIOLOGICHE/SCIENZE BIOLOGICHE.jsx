...
const ScienzeBiologiche = () => {
  React.useEffect(() => {
    ...
    const divContent = (  <div className='ProgrammaCdL'>
        ...
        <p>
        Al termine del percorso di studi lo studente consegue il titolo di Laurea in Scienze Biologiche. Il titolo conseguito appartiene al primo ciclo della formazione universitaria, ha valore legale e consente la qualificazione di dottore.
        </p>
        </div>)

    const array1=['3 anni', '2018', 'Aperto', '180CFU', 'Italiano', 'Corsi di Laurea', 'D.M. 270/2004', 'L-13 - Classe delle lauree in Scienze biologiche', 'No', 'Libero', 'PSICOLOGIA', 'CORSO DI LAUREA ORDINARIO' ];
    const titolo='SCIENZE BIOLOGICHE';
    const array2=['Titolo di Scuola Superiore', 'Titolo straniero'];
    const array3=['SCIENZE BIOLOGICHE'];
    const pdf = '/ScienzeBiologiche.pdf'; //messo in public
...
export default ScienzeBiologiche;