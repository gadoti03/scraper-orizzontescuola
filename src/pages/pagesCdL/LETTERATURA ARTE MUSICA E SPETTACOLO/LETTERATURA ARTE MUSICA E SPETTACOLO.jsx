...
const LetteraturaArteMusicaESpettacolo = () => {
  React.useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
...
const divContent = (  <div className='ProgrammaCdL'>
  ...
  <p>
  Al termine del percorso di studi lo studente consegue il titolo di Laurea in Letteratura, Arte, Musica e Spettacolo. Il titolo conseguito appartiene al primo ciclo della formazione universitaria, ha valore legale e consente la qualificazione di dottore  </p>
</div>)

    const array1=['3 anni', '2019', 'Aperto', '180CFU', 'Italiano', 'Corsi di Laurea', 'D.M. 270/2004', 'L-10 - Classe delle lauree in Lettere', 'No', 'Libero', 'LETTERE', 'CORSO DI LAUREA ORDINARIO' ];
    const titolo='LETTERATURA, ARTE, MUSICA E SPETTACOLO';
    const array2=['Titolo di Scuola Superiore', 'Titolo straniero'];
    const array3=['ARTISTICO, AUDIOVISIVO E DELLO SPETTACOLO', 'LETTERARIO', 'COMUNE'];
    const pdf = '/LetteraturaArteMusicaESpettacolo.pdf'; //messo in public
...
export default LetteraturaArteMusicaESpettacolo;